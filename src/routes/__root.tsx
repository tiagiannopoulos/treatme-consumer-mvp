...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "take one selfie and get a clear cosmetic skin snapshot, your top priorities, and options to explore." },
      { property: "og:site_name", content: "treatme" },
      { property: "og:title", content: "treatme | understand your skin from one selfie" },
      { property: "og:description", content: "take one selfie and get a clear cosmetic skin snapshot, your top priorities, and options to explore." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "Organization",
              "@id": "https://treatmeapp.com/#organization",
              name: "treatme",
              url: "https://treatmeapp.com",
              description:
                "cosmetic skin education and scan suggestions from one selfie.",
            },
            {
              "@type": "WebSite",
              "@id": "https://treatmeapp.com/#website",
              name: "treatme",
              url: "https://treatmeapp.com",
              publisher: { "@id": "https://treatmeapp.com/#organization" },
            },
          ],
        }),
      },
